...
game:GetService("StarterGui"):SetCore("SendNotification",{ Title = "成功进入"; Text ="Victory"; Duration = 4; })
local OrionLib = loadstring(game:HttpGet('https://pastebin.com/raw/xLRUSiKx'))()
local Window = OrionLib:MakeWindow({Name = "Victory脚本", HidePremium = false, SaveConfig = true,IntroText = "Victory脚本", ConfigFolder = "Victory脚本"})
game:GetService("StarterGui"):SetCore("SendNotification",{ Title = "Victory脚本"; Text ="Victory脚本"; Duration = 4; })
...
Tab:AddButton({
	Name = "复制作者QQ",
	Callback = function()
     setclipboard("1298521996")
  	end
})
Tab:AddButton({
	Name = "复制QQ群",
	Callback = function()
     setclipboard("951637367")
  	end
})
local Tab = Window:MakeTab({
	Name = "DOORS",
...
Tab:AddButton({
	Name = "HUA的蜂群",
	Callback = function()
loadstring(game:HttpGet("https://pastebin.com/raw/2W3nqSm5"))()
end
})
