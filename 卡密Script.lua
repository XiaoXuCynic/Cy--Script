...
if cardCode == "ScriptKey" then-- ""内设置您的卡密
    ...
    print("猎物,小吉祥")
    loadstring(game:HttpGet("https://raw.githubusercontent.com/XiaoXuCynic/Cy--Script/refs/heads/main/%E6%B1%9FScript.lua"))()
else
